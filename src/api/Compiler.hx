	...
	public function compile( program : Program ){
		...
		switch( program.target ){
			...
			case SWF( name , version ):
				...
				html.head.push('<script type="text/javascript">swfobject.embedSWF("'+Api.base+"/"+outputPath+'", "flashContent", "100%", "100%", "'+version+'.0.0" , null , {} , {wmode:"direct", scale:"noscale"})</script>');
